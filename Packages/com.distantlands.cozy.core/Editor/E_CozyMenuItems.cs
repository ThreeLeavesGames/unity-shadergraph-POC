...
namespace DistantLands.Cozy.EditorScripts
{
    public class E_CozyMenuItems : MonoBehaviour
    {
        ...
        [MenuItem("Tools/Cozy: Stylized Weather 3/Create Cozy Volume", false, 102)]
        public static void CozyVolumeCreation()
        {
        ...
        [MenuItem("Tools/Cozy: Stylized Weather 3/Create Cozy FX Block Zone", false, 102)]
        public static void CozyBlockZoneCreation()
        {
        ...
        [MenuItem("Tools/Cozy: Stylized Weather 3/Create Cozy Biome", false, 102)]
        public static void CozyBiomeCreation()
        {
        ...
        public static void CozyToggleTooltips()
        {
