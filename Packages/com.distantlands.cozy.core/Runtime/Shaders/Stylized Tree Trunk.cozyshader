...
Shader "Distant Lands/Cozy/URP/Demo/Stylized Tree Trunk"
{
	Properties
	{
		...
		[ASEEnd]_SnowAttraction1("Snow Attraction", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 transform63 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float2 appendResult68 = (float2(( ( transform63.x + transform63.z ) / 10.0 ) , CZY_WindTime));
				float2 texCoord69 = v.texcoord.xy * float2( 0,0 ) + appendResult68;
				float simplePerlin2D74 = snoise( texCoord69*_WindNoiseSize );
				float clampResult85 = clamp( v.vertex.xyz.y , 0.0 , 1000.0 );
				float3 MainWind83 = ( CZY_WindDirection * ( _WindStrength * simplePerlin2D74 * ( 0.1 * clampResult85 ) ) );
				float3 worldToObjDir61 = mul( GetWorldToObjectMatrix(), float4( MainWind83, 0 ) ).xyz;
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult3_g1 = (float2(WorldPosition.x , WorldPosition.z));
				...
				float4 lerpResult19_g1 = lerp( ( CZY_SnowColor * tex2D( CZY_SnowTexture, uvCZY_SnowTexture ) ) , _MainColor , ( ( pow( ( pow( WorldNormal.y , 7.0 ) * ( simplePerlin2D7_g1 * ( 1.0 - voroi5_g1 ) ) ) , 0.5 ) * _SnowAttraction1 ) > ( 1.0 - CZY_SnowAmount ) ? 0.0 : 1.0 ));
				

				float3 BaseColor = lerpResult19_g1.rgb;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float4 transform63 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float2 appendResult68 = (float2(( ( transform63.x + transform63.z ) / 10.0 ) , CZY_WindTime));
				float2 texCoord69 = v.ase_texcoord.xy * float2( 0,0 ) + appendResult68;
				float simplePerlin2D74 = snoise( texCoord69*_WindNoiseSize );
				float clampResult85 = clamp( v.vertex.xyz.y , 0.0 , 1000.0 );
				float3 MainWind83 = ( CZY_WindDirection * ( _WindStrength * simplePerlin2D74 * ( 0.1 * clampResult85 ) ) );
				float3 worldToObjDir61 = mul( GetWorldToObjectMatrix(), float4( MainWind83, 0 ) ).xyz;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 transform63 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float2 appendResult68 = (float2(( ( transform63.x + transform63.z ) / 10.0 ) , CZY_WindTime));
				float2 texCoord69 = v.texcoord0.xy * float2( 0,0 ) + appendResult68;
				float simplePerlin2D74 = snoise( texCoord69*_WindNoiseSize );
				float clampResult85 = clamp( v.vertex.xyz.y , 0.0 , 1000.0 );
				float3 MainWind83 = ( CZY_WindDirection * ( _WindStrength * simplePerlin2D74 * ( 0.1 * clampResult85 ) ) );
				float3 worldToObjDir61 = mul( GetWorldToObjectMatrix(), float4( MainWind83, 0 ) ).xyz;
...
Node;AmplifyShaderEditor.RangedFloatNode;64;-2937.719,1215.111;Inherit;False;Global;CZY_WindTime;CZY_WindTime;3;0;Create;True;0;0;0;False;0;False;1;57.1894;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;70;-2265.072,1218.461;Inherit;False;Property;_WindNoiseSize;Wind Noise Size;5;0;Create;True;0;0;0;False;0;False;0.1;0.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;76;-1465.965,811.3168;Inherit;False;Global;CZY_WindDirection;CZY_WindDirection;3;0;Create;True;0;0;0;False;0;False;0,0,0;0.09559926,0,0.4907757;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;88;-387.5068,-48.97424;Inherit;False;Property;_SnowAttraction1;Snow Attraction;6;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
WireConnection;90;4;99;0
WireConnection;90;8;61;0
ASEEND*/
//CHKSM=3919BCFC3A443C617F185899D0B201D50B08BE51